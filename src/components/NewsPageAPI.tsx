  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <main className="pt-16">
        ...
        {/* Featured Articles */}
        {!loading && !error && featuredArticles.length > 0 && selectedCategory === 'all' && !searchTerm && (
          <section className="py-16">
            <div className="container mx-auto px-6">
              <motion.h2
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm text-gray-500">{getReadTime(article)}</span>
                      </div>
                    </div>
                  </motion.div>
                ))}
            ...
            <div className="container mx-auto px-6">
              ...
              {articles.length === 0 ? (
                <div className="text-center py-12">
                  <p className="text-gray-500 text-lg">Không có bài viết nào được tìm thấy.</p>
                </div>
              ) : (
                <>
